      ...
      <div class="form-group col-sm-6">
        ...
        <div class="status">
          ...
          <div class="form-check">
            <input class="form-check-input" type="radio" name="status" id="status" value="Digunakan" required>
            <label class="form-check-label" for="flexRadioDefault1">Digunakan</label>
          </div>

          <div class="form-check">
            <input class="form-check-input" type="radio" name="status" id="status" value="Tidak Digunakan" required>
